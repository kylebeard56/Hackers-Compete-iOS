...
#ifndef HACKERS_WATCH_APP_SWIFT_H
#define HACKERS_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hackers_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17Hackers_Watch_App15WatchRoundStore")
@interface WatchRoundStore : NSObject
...
@class WCSession;
@class NSString;
@interface WatchRoundStore (SWIFT_EXTENSION(Hackers_Watch_App)) <WCSessionDelegate>
