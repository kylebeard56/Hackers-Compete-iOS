...
private let fugazOneName: String = "Fugaz One"
...
extension Font {
    ...
    static func fugazOne(size: CGFloat) -> Font {
        return Font.custom(fugazOneName, size: size)
    }
}
...
extension UIFont {
    ...
    static func fugazOne(size: CGFloat) -> UIFont {
        return UIFont(name: fugazOneName, size: size) ?? UIFont.systemFont(ofSize: size)
    }
}
