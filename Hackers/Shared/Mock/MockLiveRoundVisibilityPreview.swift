//
//  MockLiveRoundVisibilityPreview.swift
//  Hackers
//
//  Mock for ScorecardVisibilitySheet preview: 4 groups × 4 players, 4 teams, mixed.
//

import SwiftUI

/// Live round: 16 players, 4 tee groups, 4 teams (Red, Blue, Green, Purple). Each group has one player from each team.
enum MockLiveRoundVisibilityPreview {
    static let roundID = "mock_round_visibility_preview"
