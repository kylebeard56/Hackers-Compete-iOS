            ...
            if UIScreen.isSmall {
                HStack(spacing: 12) {
                    ...
                    ZStack {
                        ...
                        AwesomeImage(rawIcon: "f8c3".unicode, style: .light, size: 17, color: .systemHackersGreen)
                    }
                ...
                ZStack {
                    ...
                    AwesomeImage(rawIcon: "f8c3".unicode, style: .light, size: 28, color: .systemHackersGreen)
                }
