            ...
            if UIScreen.isSmall {
                HStack(spacing: 12) {
                    ...
                    ZStack {
                        ...
                        AwesomeImage(rawIcon: "e3ed".unicode, style: .light, size: 17, color: .systemHackersGreen)
                    }
                ...
                ZStack {
                    ...
                    AwesomeImage(rawIcon: "e3ed".unicode, style: .light, size: 28, color: .systemHackersGreen)
                }
...
struct VegasFrontView_Previews: PreviewProvider {
    static var previews: some View {
        VegasFrontView(viewModel: RoundViewModel(), hole: 1)
    }
}
