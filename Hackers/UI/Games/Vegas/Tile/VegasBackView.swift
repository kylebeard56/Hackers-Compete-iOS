...
Team 1 shoots a 6 and 8 while Team 2 shoots a 9 and 5. Team 1’s score is a 68 and Team 2’s is a 59. If a team has a double-digit score, it gets rolled over i.e. 7 and 10 would be 80 (70+ 10), not 710.

Vegas Style is great for pairings that have a volatile play style.

The winning team has lowest sum of points after a series of holes.
"""
                )
