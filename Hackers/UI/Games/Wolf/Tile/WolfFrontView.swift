...
struct WolfFrontView: View {
    ...
    private var header: some View {
        VStack(spacing: 8) {
            if UIScreen.isSmall {
                HStack(spacing: 12) {
                    ...
                    ZStack {
                        ...
                        AwesomeImage(rawIcon: "e414".unicode, style: .light, size: 17, color: .systemHackersGreen)
                    }
                ...
                ZStack {
                    ...
                    AwesomeImage(rawIcon: "e414".unicode, style: .light, size: 28, color: .systemHackersGreen)
                }
            ...
            Text("An intense game of best ball where team structure influences scoring strategy.")
